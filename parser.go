...
// TODO: investigate duckdb appender API for Go. Might be just as quick as writing to CSV due to reduced disk usage for smaller file size.
//  especially if the appender can run in a separate cpu thread to the parser.
